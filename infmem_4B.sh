...
YOUR_PROJECT_NAME=
YOUR_RUN_NAME=
PROJ_DIR=path_to_$YOUR_RUN_NAME
DATASET_ROOT=
MODEL_PATH=qwen3_4B_thinking_shorter_mixed_traj_distilled 
...
python3 -m verl.trainer.main_ppo \
    recurrent.enable=infmem \
    recurrent.infmem.config.chunk_size=5000 \
    recurrent.infmem.config.max_memorization_length=1536 \
    recurrent.infmem.config.max_final_response_length=1536 \
    ...
    trainer.total_epochs=30 2>&1 | tee logs/${YOUR_RUN_NAME}.log