...
class LLMGenerationManager:
    ...
    def run_llm_loop(self, gen_batch, timing_raw) -> Tuple[DataProto, torch.BoolTensor, torch.LongTensor]:
        ...
        ############ Start Modification: get final_reward when finish ###############
        final_mask, sample_index, final_rewards = self.agent.end()
        ...
        dp = DataProto.concat(gen_output_list)
        return dp, final_mask, sample_index, final_rewards # pyright: ignore
